...
$BIN tx $BIN_TX mod-provider -y -b block --from "$USER" --keyring-backend test -- "$PUBKEY" "$SERVICE" "http://localhost:3636/metadata.json" 1 1 10 5256000 10uuram 10uuram 10
